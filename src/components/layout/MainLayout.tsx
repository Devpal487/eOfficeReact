    ...
    const items1 = [
      {
        ...
        childMenu:[
          ...
          // {menuId: 19, menuName: 'Committee/Group', path:"/Committee/CommitteeMaster",displayNo:0},
          // {menuId: 20, menuName: 'Committee Emp Mapping', path:"/Committee/CommitteeEmployeeMapping",displayNo:0},
          ...
          {menuId: 24, menuName: 'Section', path:"/master/SectionMaster",displayNo:0},
