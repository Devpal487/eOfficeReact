...
import TranslateQuill from "../../../TranslateQuill";
...
export default function Correspondence() {
  ...
  const getListbyid = (id: any) => {
    ...
    api.post(`Correspondance/GetCorrespondance`, collectData).then((res) => {
        ...
        if (data.length > 0) {
          const columns: GridColDef[] = [
            ...
            },
            {
              ...
              renderCell: (params) => {
                return (
                  <a href="#" onClick={(event) => getFileViewById(params.row)}>
                    {params.row.fileNo}
                  </a>
                );
              },
