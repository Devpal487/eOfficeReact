...
export default function AplicantDetails() {
  ...
  const routeChangeEdit = (row: any) => {
    // console.log(row);
    let path = `/master/AplicantDetailsEdit`;
    navigate(path, {
      state: row,
    });
  };
  ...
  const accept = () => {
    ...
    api
      .delete(`CertificateApply/DeleteCertificateApply`, { data: collectData })
      .then((response) => {
