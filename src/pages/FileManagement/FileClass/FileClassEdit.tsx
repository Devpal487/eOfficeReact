...
const FileClassEdit = (props: Props) => {
  ...
  const formik = useFormik({
    initialValues: {
        fileClassid: location.state.id,
      classDescription: location.state.classDescription,
      shortName: location.state.shortName,
      weedingOutAuthority: location.state.weedingOutAuthority,
    },
            ...
            <Grid item xs={12} container spacing={2}>
              <Grid lg={6} sm={6} xs={12} item>
                ...
                {formik.touched.classDescription && formik.errors.classDescription ? (
                  <div style={{color:"red", margin:"5px"}}>{String(formik.errors.classDescription)}</div>
                ) : null}
              </Grid>
