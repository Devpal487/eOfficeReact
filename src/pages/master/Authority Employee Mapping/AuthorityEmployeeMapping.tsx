...
export default function AuthorityEmployeeMapping() {
  ...
  const [selectEmployeeName, setSelectEmployeeName] = useState([
    { value: "-1", label: t("text.SelectEmployeeName") },
  ]);
  const [selectAuthority, setSelectAuthority] = useState([
    { value: "-1", label: t("text.selectAuthority") },
  ]);
  ...
  const accept = () => {
    ...
    api
      .delete(`EmployeesAuthority/DeleteEmployeesAuthority`, {
        data: collectData,
      })
      .then((response) => {
  ...
  const getList = () => {
    ...
    try {
      api
        .post(`EmployeesAuthority/GetEmployeesAuthority`, collectData)
        .then((res) => {
                ...
                renderCell: (params) => {
                  return [
                    ...
                    >
                      ...
                      <Switch
                        checked={Boolean(
                          params.row.authorityStatus === "Y" ? true : false
                        )}
                        style={{
                          color:
                      ...
                      <TextField
                        ...
                        label={
                          <CustomLabel
                            ...
                            required={requiredFields.includes("authorityId")}
                          />
                        }
                      />
                    )}
                  ...
                  <Autocomplete
                    ...
                    value={
                      selectAuthority.find(
                        (option: any) =>
                          option.value === formik.values.authorityId
                      ) || null
                    }
                    fullWidth
                    size="small"
                ...
                <Grid item xs={4} sm={4}>
                  <Autocomplete
                    ...
                    value={
                      selectStatus.find(
                        (option: any) =>
                          option.value === formik.values.authorityStatus
                      ) || null
                    }
                    fullWidth
                    size="small"
                ...
                <Grid item xs={4} sm={4}>
                  <Autocomplete
                    ...
                    value={
                      selectSection.find(
                        (option: any) =>
                          option.value === formik.values.sectionId
                      ) || null
                    }
                    fullWidth
                    size="small"
