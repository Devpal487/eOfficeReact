...
const PageCreateEdit = (props: Props) => {
  ...
  const handleButtonClick = () => {
    const mergedFieldValue = `${formik.values.rlId || ""}-${
      formik.values.rFileType || ""
    }-${selectedYear || ""}-${sNo || ""}`;
  ...
  const getimgbyid = () => {
    ...
    api.post(`ReferenceDiary/GetReferenceDiary`, collectData).then((res) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      ...
      const response = await api.post(
        `ReferenceDiary/AddUpdateReferenceDiary`,
        values
      );
            ...
            <Grid item xs={12} container spacing={2}>
              ...
              <Grid item lg={4} md={4} xs={12}>
                <Autocomplete
                  ...
                  value={
                    LetterType.find(
                      (opt: any) => opt.value == formik.values.rlId
                    ) || null
                  }
              ...
              {formik.values.letterBy !== "dispatch" &&
                formik.values.letterBy !== "received/dispatch" && (
                  <Grid item lg={4} xs={12}>
                    <Autocomplete
                      ...
                      value={
                        PriorityOps.find(
                          (opt: any) => opt.value == formik.values.rPriority
                        ) || null
                      }
                      size="small"
                      onChange={(event, newValue: any) => {
              ...
              <Grid item lg={4} md={4} xs={12}>
                <Autocomplete
                  ...
                  value={
                    LanguageOption.find(
                      (opt: any) => opt.value == formik.values.rLanguage
                    ) || null
                  }
                  size="small"
                  onChange={(event, newValue: any) => {
              ...
              <Grid item lg={4} md={4} xs={12}>
                <Autocomplete
                  ...
                  value={
                    FileOption.find(
                      (opt: any) => opt.value == formik.values.rFileType
                    ) || null
                  }
                  size="small"
                  onChange={(event, newValue: any) => {
                ...
                formik.values.letterBy !== "received/dispatch" && (
                  <Grid item lg={4} md={4} xs={12}>
                    <Autocomplete
                      ...
                      value={
                        RootOps.find(
                          (opt: any) => opt.value == formik.values.routeID
                        ) || null
                      }
                      size="small"
                      onChange={(event, newValue: any) => {
                        console.log(
                          "🚀 ~ PageCreateEdit ~ newValue:",
                          newValue
                        );
              ...
              <Grid
                ...
                sm={12}
                item
                sx={{ marginTop: "3px", overflow: "auto" }}
              >
                <div>
                  <IconButton
                  ...
                  <strong style={{ textDecoration: "underline" }}>
                    {openCollaps ? "Close" : "Open"} Employee Table
                  </strong>
                          ...
                          >
                            ...
                            >
                              <TextField
                                ...
                                style={{ backgroundColor: "white" }}
                                onChange={(e: any) =>
                                  setDateOfApproval(e.target.value)
                                }
                              />
                            </div>
                          </th>
